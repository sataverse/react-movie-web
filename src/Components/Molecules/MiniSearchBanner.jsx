...
import CheckIcon from "../Atoms/Svg/CheckIcon"
...
function MiniSearch({item, setThis}) {
    return (
        <>
            ...
            <ModalPlaylistAddButton onClick={() => setThis(item.id, item.title)}><CheckIcon width={50} height={50}/></ModalPlaylistAddButton>
        </>
    )
}
